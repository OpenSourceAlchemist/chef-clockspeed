...
default[:clockspeed][:clock_type] = 'ntp'
...
default[:clockspeed][:base] = File.join(node[:clockspeed][:prefix],'clockspeed')
default[:clockspeed][:bin_dir] = File.join(node[:clockspeed][:base],'bin')
